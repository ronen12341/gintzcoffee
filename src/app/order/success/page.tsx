  ...
  return (
    <section className="py-20 bg-cream min-h-[60vh]">
      ...
      <div className="max-w-2xl mx-auto px-4 text-center">
        ...
        <div className="bg-gradient-to-b from-cream to-cream-dark text-brown rounded-3xl p-6 shadow-sm ring-1 ring-brown/[0.06] mb-6">
          <p className="text-sm text-brown/70 mb-2">צריך לדבר איתנו עכשיו?</p>
          <a
            href="tel:039600550"
