...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "מכונה שנרכשת באתר נשלחת עם שליח עד הדלת, ללא התקנה — היא מגיעה מוכנה לשימוש עם הוראות ההפעלה של היצרן. מחפשים פתרון קפה למשרד עם התקנה, הדרכה לצוות ושירות שוטף? זה בדיוק מה שכלול בפתרונות הקפה למשרד שלנו.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "אספקה עד 7 ימי עסקים מיום ההזמנה, ישירות לעסק שלכם. ללקוחות קבועים אנחנו מציעים לוח אספקות קבוע שמתאים לצריכה שלהם.",
      },
      {
