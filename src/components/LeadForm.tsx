  ...
  return (
    <form onSubmit={handleSubmit} className={`space-y-4 ${className}`} noValidate>
      ...
      <button
        type="submit"
        disabled={sending}
        className="w-full bg-gold hover:bg-gold-dark disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-3 px-6 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 text-base"
      >
